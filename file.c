...
/*   Updated: 2022/10/20 10:18:53 by atabiti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double normalizeAngle(double angle) {
	...
	// printf("mlx_srct->rays.rotate_angle=  %f \n\n", mlx_srct->plyr.rotate);
...
void	update_pos(t_mlx *mlx_srct, t_parce *game)
{
	...
	double	new_y;
	mlx_srct->plyr.rotate += mlx_srct->plyr.rotaion_speed * mlx_srct->plyr.turn_direction;
	mlx_srct->plyr.rotate = normalizeAngle(mlx_srct->plyr.rotate);
