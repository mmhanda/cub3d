...
#    Updated: 2022/10/22 08:56:05 by atabiti          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFILES = main.c parcing/get_map.c parcing/init_map_stuct.c parcing/get_colors.c parcing/check_colors.c parcing/free_c_f_path_rgb.c \
		...
		parcing/refield_map.c graphics/main_win.c graphics/handl_player.c graphics/paint.c graphics/make_moves.c graphics/render.c graphics/rays.c graphics/raycaster_0.c    graphics/raycaster_1.c    graphics/distancebtwpts.c    graphics/draw_floor_ceilling.c     graphics/horizontal_intersections.c graphics/vertical_intersections.c
